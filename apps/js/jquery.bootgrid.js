    ...
    function loadColumns()
    {
        ...
        firstHeadRow.children().each(function ()
        {
            var $this = $(this),
                data = $this.data(),
                /* Chris fix:
                    data-something attributes must be lowercase
                */
                column = {
                    id: data.columnId,
                    ...
                    headerAlign: data.headeralign || "left", //fix
                    cssClass: data.cssclass || "", //fix
                    headerCssClass: data.headercssclass || "", //fix
